...
import { __extends, __decorate, __awaiter, __generator, __spread, __read, __metadata } from 'tslib';
...
function format(template, tokens, removeEmptyTokens) {
    if (removeEmptyTokens === void 0) { removeEmptyTokens = false; }
    Object.keys(tokens || {})
        .forEach((/**
     * @param {?} key
     * @return {?}
...
var AppInitializerService = /** @class */ (function () {
    ...
    function () {
        ...
        if (siteInfo && siteInfo[AppInitializerService.tokenExpireDateKey]) {
            ...
            /** @type {?} */
            var lastTokenValidationDatesMatch = isDate$1(lastTokenInvalidateDate) && isDate$1(tokenExpireDate)
...
function almostEqual(number1, number2, precision) {
    if (precision === void 0) { precision = DEFAULT_POINT_EQUALITY_PRECISION; }
    /** @type {?} */
...
function humanize(text, upperCaseAllWords) {
    if (upperCaseAllWords === void 0) { upperCaseAllWords = true; }
    /** @type {?} */
    var result = (text || '')
...
function average(list) {
     ...
     * @return {?}
     */
    function (value) { return isNumber$1(value); }));
    /** @type {?} */
...
function toFormDataString(value, encodeData) {
    if (encodeData === void 0) { encodeData = true; }
    /** @type {?} */
    var stringValue;
    if (isNotValue(value)) {
        stringValue = '';
...
var DataSourceService = /** @class */ (function (_super) {
    ...
    function (dataSourceId, table, whereClause, version, params) {
        if (whereClause === void 0) { whereClause = SELECT_ALL_WHERE_CLAUSE; }
        /** @type {?} */
        var url = this.getUrlWithId(dataSourceId, this.dsConfig.tableActionEndpoint, {
            table: table,
            action: 'count'
...
var EsriMapServerService = /** @class */ (function (_super) {
    ...
    function (serviceUrl, layerId) {
         ...
         * @return {?}
         */
        function (response) { return _this.handleEsriResponseError(response, serviceUrl); })), map((/**
    ...
    function (serviceUrl, networkLayerId, routeId, x, y, viewDate, inSpatialReferenceId, outputSpatialReferenceId) {
        if (inSpatialReferenceId === void 0) { inSpatialReferenceId = 4326; }
        if (outputSpatialReferenceId === void 0) { outputSpatialReferenceId = 4326; }
        /** @type {?} */
        var locations = [
    ...
    /** @nocollapse */
    EsriMapServerService.ctorParameters = function () { return [
        { type: HttpClient },
        { type: EsriConfig },
        { type: DataSourceConfig },
        { type: Logger }
...
function isPositionError(position) {
    ...
    /** @type {?} */
    var isError = !error || isNumber$1(error.code);
    return isError;
}
    ...
    mergeDeepArray(target, source, {
        ...
        function (targetField, sourceField) {
            if (targetField.domain && sourceField.domain && sourceField.domain.codedValues) {
                 ...
                 * @return {?}
                 */
                function (c) { return isNumber$1(c.order); }));
